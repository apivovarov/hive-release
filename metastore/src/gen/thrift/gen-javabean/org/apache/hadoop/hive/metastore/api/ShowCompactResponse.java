            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.compacts = new ArrayList<ShowCompactResponseElement>(_list426.size);
                for (int _i427 = 0; _i427 < _list426.size; ++_i427)
                {
                  ShowCompactResponseElement _elem428; // required
                  _elem428 = new ShowCompactResponseElement();
                  _elem428.read(iprot);
                  struct.compacts.add(_elem428);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.compacts != null) {
        if (struct.isSetCompacts()) {
          oprot.writeFieldBegin(COMPACTS_FIELD_DESC);
          {
            ...
            for (ShowCompactResponseElement _iter429 : struct.compacts)
            {
      ...
      if (struct.isSetCompacts()) {
        {
          ...
          for (ShowCompactResponseElement _iter430 : struct.compacts)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.compacts = new ArrayList<ShowCompactResponseElement>(_list431.size);
          for (int _i432 = 0; _i432 < _list431.size; ++_i432)
          {
            ShowCompactResponseElement _elem433; // required
            _elem433 = new ShowCompactResponseElement();
            _elem433.read(iprot);
            struct.compacts.add(_elem433);
          }
        }
        struct.setCompactsIsSet(true);
      }

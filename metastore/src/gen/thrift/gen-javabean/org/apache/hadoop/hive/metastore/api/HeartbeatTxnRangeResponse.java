        ...
        switch (schemeField.id) {
          case 1: // ABORTED
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set410 = iprot.readSetBegin();
                struct.aborted = new HashSet<Long>(2*_set410.size);
                for (int _i411 = 0; _i411 < _set410.size; ++_i411)
                {
                  long _elem412; // required
                  _elem412 = iprot.readI64();
                  struct.aborted.add(_elem412);
                }
                iprot.readSetEnd();
              }
          ...
          case 2: // NOSUCH
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set413 = iprot.readSetBegin();
                struct.nosuch = new HashSet<Long>(2*_set413.size);
                for (int _i414 = 0; _i414 < _set413.size; ++_i414)
                {
                  long _elem415; // required
                  _elem415 = iprot.readI64();
                  struct.nosuch.add(_elem415);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.aborted != null) {
        oprot.writeFieldBegin(ABORTED_FIELD_DESC);
        {
          ...
          for (long _iter416 : struct.aborted)
          {
      ...
      if (struct.nosuch != null) {
        oprot.writeFieldBegin(NOSUCH_FIELD_DESC);
        {
          ...
          for (long _iter417 : struct.nosuch)
          {
  ...
  private static class HeartbeatTxnRangeResponseTupleScheme extends TupleScheme<HeartbeatTxnRangeResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (long _iter418 : struct.aborted)
        {
      ...
      }
      {
        ...
        for (long _iter419 : struct.nosuch)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, HeartbeatTxnRangeResponse struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TSet _set420 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.aborted = new HashSet<Long>(2*_set420.size);
        for (int _i421 = 0; _i421 < _set420.size; ++_i421)
        {
          long _elem422; // required
          _elem422 = iprot.readI64();
          struct.aborted.add(_elem422);
        }
      }
      struct.setAbortedIsSet(true);
      {
        org.apache.thrift.protocol.TSet _set423 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.nosuch = new HashSet<Long>(2*_set423.size);
        for (int _i424 = 0; _i424 < _set423.size; ++_i424)
        {
          long _elem425; // required
          _elem425 = iprot.readI64();
          struct.nosuch.add(_elem425);
        }
      }
      struct.setNosuchIsSet(true);
    }

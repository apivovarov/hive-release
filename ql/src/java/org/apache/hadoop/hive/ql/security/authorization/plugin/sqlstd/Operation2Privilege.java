...
public class Operation2Privilege {
  ...
  static {
    ...
    op2Priv.put(HiveOperationType.EXPLAIN, PrivRequirement.newIOPrivRequirement(SEL_NOGRANT_AR,
        SEL_NOGRANT_AR)); //??

    op2Priv.put(HiveOperationType.CREATEDATABASE,
        PrivRequirement.newIOPrivRequirement(ADMIN_PRIV_AR, OWNER_INS_SEL_DEL_NOGRANT_AR));
    ...
    op2Priv.put(HiveOperationType.CREATETABLE_AS_SELECT, PrivRequirement.newIOPrivRequirement(SEL_NOGRANT_AR, null));

    // QUERY,LOAD op can contain an insert & ovewrite, so require insert+delete privileges on output
    op2Priv.put(HiveOperationType.QUERY, PrivRequirement.newIOPrivRequirement(SEL_NOGRANT_AR,
    ...
    op2Priv.put(HiveOperationType.LOAD, PrivRequirement.newIOPrivRequirement(OWNER_INS_SEL_DEL_NOGRANT_AR,
        arr(SQLPrivTypeGrant.INSERT_NOGRANT, SQLPrivTypeGrant.DELETE_NOGRANT)));
    ...
    op2Priv.put(HiveOperationType.CREATEVIEW, PrivRequirement.newIOPrivRequirement(SEL_GRANT_AR, null));
    ...
    op2Priv.put(HiveOperationType.CREATETABLE,
        PrivRequirement.newIOPrivRequirement(OWNER_INS_SEL_DEL_NOGRANT_AR, OWNER_PRIV_AR));
    ...
    op2Priv.put(HiveOperationType.GRANT_PRIVILEGE, PrivRequirement.newIOPrivRequirement(null,
        null));
    op2Priv.put(HiveOperationType.REVOKE_PRIVILEGE, PrivRequirement.newIOPrivRequirement(null,
        null));
    ...
    op2Priv.put(HiveOperationType.SHOW_ROLE_GRANT, PrivRequirement.newIOPrivRequirement(null,
        null));
    op2Priv.put(HiveOperationType.SHOW_ROLE_PRINCIPALS, PrivRequirement.newIOPrivRequirement(null,
        null));

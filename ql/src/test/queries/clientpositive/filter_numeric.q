...
select key, value, hr from partint where hr < 11 order by key, value, hr;

explain select key, value, hr from partint where hr <= 12 and hr > 11;
select key, value, hr from partint where hr <= 12 and hr > 11 order by key, value, hr;

explain select key, value, hr from partint where hr between 11 and 12;
select key, value, hr from partint where hr between 11 and 12 order by key, value, hr;

explain select key, value, hr from partint where hr not between 12 and 14;
select key, value, hr from partint where hr not between 12 and 14 order by key, value, hr;

explain select key, value, hr from partint where hr < 13;
select key, value, hr from partint where hr < 13 order by key, value, hr;
